                    ...
                    <div className="mt-10 grid space-y-4">
                        ...
                        <button
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="absolute left-0 w-5 text-gray-700">
                                ...
                                <span
                                    className="block w-max font-semibold tracking-wide text-black p-2 text-sm transition dark:text-white duration-300 group-hover:text-blue-600 sm:text-base">Continue
                                    with Facebook
                                </span>
                            </div>
                        </button>
