...
const Signin = () => {
    return (
        <div>
            <NavBar />
        <div className="bg-white shadow-lg rounded-lg mx-auto mt-5 conBox">
            {/* <div className="bg-black text-white p-8 rounded-t-lg md:rounded-l-lg md:rounded-t-none flex flex-col justify-center items-center md:w-1/2 ">
                ...
                <div className="mt-8 w-full h-auto rounded-lg imgCOn">
                <div className="items-center justify-center mt-4 space-x-4">
